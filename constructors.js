...
User.prototype.removeSavedPost= function(num){
      let index = this.savedPosts.findIndex(element => element.id === num);
  ...
  User.prototype.changePostRating = function(num1, num2){
      let ratingIndex = this.savedPosts.findIndex(element => element.id === num1)
      this.savedPosts[ratingIndex].rating = num2
  }